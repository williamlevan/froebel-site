        ...
        return (
            <div className="event-card">
                ...
                <div className="event-card-actions">
                    <button className="cancel-shift-button" onClick={handleCancelShift}>Cancel Shift</button>
                </div>
            </div>
        )
    } else if (shift.type === 'school') {
        return (
            <div className="event-card">
                <div className="event-card-left-bar"></div>
                <div className="event-card-content">
                ...
                <div className="event-card-actions">
                    <button className="edit-shift-button" onClick={handleEditShift}>Edit Shift</button>
                </div>
                <div className="event-card-actions">
                    <button className="cancel-shift-button" onClick={handleCancelShift}>Cancel Shift</button>
                </div>
